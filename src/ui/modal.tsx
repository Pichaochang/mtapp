...
const ModalHeader = React.memo(({ title, dismiss }: ModalHeaderProps) => {
  return (
    <>
      {title && (
        <View className="rounded-t-[12px] dark:bg-[#18191b]">
          {/* <View className="mb-0 h-1 w-12 self-center bg-gray-400 dark:bg-gray-700" /> */}
          <View className="flex-row  bg-white px-2 py-4 dark:bg-[#18191b] ">
